...
ifeq ($(config),debug)
  ...
  OBJDIR = obj/Debug/grpc_cb_static
  DEFINES +=
...
ifeq ($(config),release)
  ...
  TARGET = $(TARGETDIR)/libgrpc_cb.a
  OBJDIR = obj/Release/grpc_cb_static
  DEFINES += -DNDEBUG
  INCLUDES += -I../include -I../third_party/grpc/include -I../third_party/grpc/third_party/protobuf/src -I../src/cpp_cb
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/service_stub.o: ../src/cpp_cb/client/service_stub.cc
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/byte_buffer.o: ../src/cpp_cb/common/byte_buffer.cc
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
